...
int main(int argc, char** argv)
{
  ...
  actionlib::SimpleActionClient<aeplanner_msgs::aeplannerAction> aep_ac("make_plan",
                                                                        true);
  ...
  while (ros::ok())
  {
    ...
    //         << aep_ac.getResult()->planning_time.data << ", " <<
    //         aep_ac.getResult()->collision_check_time.data << ", "
    //         << fly_time << ", " << srv.response.coverage << ", " << srv.response.free
    //         << ", " << srv.response.occupied
    //         << ", " << srv.response.unmapped << ", " << aep_ac.getResult()->tree_size
    //         << std::endl;
