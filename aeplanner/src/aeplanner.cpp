...
point_rtree AEPlanner::getRtree(std::shared_ptr<octomap::OcTree> ot, octomap::point3d min, octomap::point3d max)
{
  point_rtree rtree;
...
std::shared_ptr<RRTNode> AEPlanner::initialize(value_rtree* rtree, const Eigen::Vector4d& current_state)
{
  best_node_ = nullptr;
...
void AEPlanner::initializeKDTreeWithPreviousBestBranch(value_rtree* rtree, std::shared_ptr<RRTNode> root)
{
...
std::shared_ptr<RRTNode> AEPlanner::chooseParent(const value_rtree& rtree, std::shared_ptr<point_rtree> stl_rtree,
...
bool AEPlanner::collisionLine(std::shared_ptr<point_rtree> stl_rtree, Eigen::Vector4d p1, Eigen::Vector4d p2, double r)
{
